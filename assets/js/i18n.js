...
const TRANSLATIONS = {
  ...
  en: {
    ...
    'news.cdl.text':        'Admitted to the <strong>Creative Destruction Lab (CDL) Next Gen Computing Stream</strong> for the 2026/27 program year &mdash; jointly run by CDL-Paris and CDL-Berlin in partnership with <strong>HEC Paris</strong>, <strong>ESMT Berlin</strong>, and TU Munich&rsquo;s Campus Heilbronn.',
  ...
  de: {
    ...
    'news.tag.accelerator': 'Accelerator',
    'news.cdl.date':        'Sep 2026',
    'news.cdl.text':        'Aufnahme in den <strong>Creative Destruction Lab (CDL) Next Gen Computing Stream</strong> für das Programmjahr 2026/27 &mdash; gemeinsam durchgeführt von CDL-Paris und CDL-Berlin in Partnerschaft mit <strong>HEC Paris</strong>, <strong>ESMT Berlin</strong> und dem Campus Heilbronn der TU München.',
  ...
  ko: {
    ...
    'news.cdl.text':        '2026/27 프로그램 기수로 <strong>Creative Destruction Lab(CDL) Next Gen Computing Stream</strong>에 선발되었습니다 &mdash; CDL-파리와 CDL-베를린이 공동 운영하며, <strong>HEC 파리</strong>, <strong>ESMT 베를린</strong>, 뮌헨공과대학교(TUM) 하일브론 캠퍼스와 협력합니다.',
