...
const TRANSLATIONS = {
  ...
  de: {
    ...
    'banner.btn.about':      '&Uuml;ber mich',
    'banner.btn.research':   'Forschung',
    'banner.more':           'Mehr erfahren',

    'intro.title': 'Forschungs&uuml;berblick',
    'intro.text':  'Meine Forschung konzentriert sich auf hochkapazitive Terahertz (THz)-Funkkommunikation<br />und deren Integration in zukünftige 6G-Photoniknetzwerkinfrastrukturen.<br />Am Fraunhofer HHI entwickle ich fortschrittliche digitale Signalverarbeitungstechniken<br />und experimentelle Systeme f&uuml;r Datenraten &uuml;ber 100&thinsp;Gbit/s auf THz-Funkstrecken.<br />Dar&uuml;ber hinaus bin ich als <strong>Lehrbeauftragter</strong> an der HTW Berlin und BHT Berlin t&auml;tig<br />und unterrichte Kommunikationstechnik auf Bachelor- und Masterniveau.',
    ...
    'research.1.text':  'Ich entwickle und charakterisiere experimentelle Hochgeschwindigkeits-Funk&uuml;bertragungs&shy;systeme im 300&thinsp;GHz-Band (WR-3). Meine Forschung umfasst die gesamte Signalkette &mdash; von der photonischen Aufwärtskonvertierung mit PIN-Photodioden- und WR3-Senderbaugruppen bis zur empf&auml;ngerseitigen DSP und Streckencharakterisierung &mdash; mit nachgewiesenen Durchs&auml;tzen &uuml;ber 109&thinsp;Gbit/s und einem Rekordwert von <strong>221&thinsp;Gb/s Dual-Polarisation</strong> &uuml;ber 500&thinsp;m.',
    'research.2.title': 'Probabilistisches Konstellationsshaping<br />&amp; Ratenadaption',
    'research.2.text':  'Ein zentrales Thema meiner Forschung ist das probabilistische Konstellationsshaping (PCS) f&uuml;r THz-Funkverbindungen. PCS erm&ouml;glicht eine flexible, ratenadaptive Modulation durch Verschiebung der Symbolverteilung in Richtung der Shannon-Grenze. Ich untersuche zeitadaptives PCS f&uuml;r kombinierte optische/THz-Strecken, den Einfluss von Photodioden-Nichtlinearit&auml;ten und deren Kompensation mittels neuronaler Netzwerke.',
    'research.3.title': 'Konvergierte optische &amp; THz-<br />Verbindungen f&uuml;r 6G-Netze',
    'research.3.text':  'Ich untersuche die nahtlose Integration von THz-Funksegmenten in Glasfaser-Backhaul&shy;netzwerke f&uuml;r zuk&uuml;nftige 6G-Anforderungen. Dies umfasst die Analyse wetterabh&auml;ngiger Streckenverfügbarkeiten, Systementwicklung f&uuml;r hochkapazitive 6G-Transportnetze sowie adaptive Basisband&shy;techniken f&uuml;r konvergierte optische/THz-Verbindungen &mdash; das Thema meiner Doktorarbeit an der TU Berlin.',
    ...
    'contact.text':        'Ich freue mich &uuml;ber Anfragen zu Forschungskooperationen, Projekten<br />und M&ouml;glichkeiten im Bereich THz-Kommunikation und photonische Netzwerke.',
    ...
    'about.page.title':  '&Uuml;ber mich | In-Ho Baek',
    'about.header':      '&Uuml;ber mich',
    'about.subtitle':    'Wissenschaftler &amp; Doktorand &mdash; Fraunhofer HHI, Berlin',

    'about.profile.title':'Berufliches Profil',
    'about.profile.p1':   'Ich bin Wissenschaftler am <strong>Fraunhofer-Institut f&uuml;r Nachrichtentechnik, Heinrich-Hertz-Institut (HHI)</strong>, Berlin, in der Abteilung Photonische Netze und Systeme, wo ich seit Juli 2021 t&auml;tig bin. Parallel dazu promoviere ich an der <strong>Technischen Universit&auml;t Berlin (TUB)</strong> unter dem Arbeitstitel <em>&ldquo;Untersuchung adaptiver Basisbandtechniken f&uuml;r konvergierte optische/THz-Funkverbindungen.&rdquo;</em>',
    'about.profile.p2':   'Meine Forschung konzentriert sich auf hochkapazitive THz-Funkkommunikation und deren Integration in 6G-Photoniknetzwerke. Ich entwickle fortschrittliche DSP-Algorithmen f&uuml;r ratenadaptive THz-Strecken und führe experimentelle Charakterisierungen photonischer Sendebaugruppen durch &mdash; f&uuml;r probabilistisch geformte THz-Funkübertragungen &uuml;ber 100&thinsp;Gbit/s. Zudem erforsche ich neuronalnetzbasierte Ans&auml;tze zur Kompensation von Nichtlinearit&auml;ten.',
    'about.profile.p3':   'Neben meiner Forschungst&auml;tigkeit bin ich als Lehrbeauftragter f&uuml;r Informations- und Kommunikationsprogramme an Berliner Hochschulen t&auml;tig.',

    'about.edu.title':           'Ausbildung',
    'about.edu.phd.title':       'Promotion &mdash; Elektrotechnik / Informationstechnik',
    'about.edu.phd.body':        '<strong>Technische Universit&auml;t Berlin (TUB)</strong>, Berlin &mdash; 2021&ndash;2026<br />Arbeitstitel: <em>Untersuchung adaptiver Basisbandtechniken f&uuml;r konvergierte optische/THz-Funkverbindungen</em><br />Angestrebter Abschluss: Dr.-Ing.',
    'about.edu.msc.title':       'M.Sc. &mdash; Elektrotechnik / Informationstechnik',
    'about.edu.msc.body':        '<strong>Karlsruher Institut f&uuml;r Technologie (KIT)</strong>, Karlsruhe &mdash; 2018&ndash;2021<br />Schwerpunkte: Kommunikationstechnik &amp; Optische Kommunikation<br />Masterarbeit (am IPQ, KIT): <em>Data-Aided Carrier Phase Recovery Algorithms for Coherent Optical Communication Systems</em>',
    'about.edu.exchange.title':  'Austauschprogramm &mdash; Elektrotechnik &amp; Philosophie',
    'about.edu.exchange.body':   '<strong>Korea Advanced Institute of Science and Technology (KAIST)</strong>, Daejeon, S&uuml;dkorea &mdash; 2018&ndash;2019<br />Kurse: Radarsystemtechnik &bull; MIMO Funk&uuml;bertragung &bull; Wissenschaftsphilosophie<br />Gef&ouml;rdert durch das <strong>Baden-W&uuml;rttemberg-Stipendium 2018</strong>',
    'about.edu.bsc.title':       'B.Sc. &mdash; Elektrotechnik / Informationstechnik',
    'about.edu.bsc.body':        '<strong>Karlsruher Institut f&uuml;r Technologie (KIT)</strong>, Karlsruhe &mdash; 2013&ndash;2018<br />Bachelorarbeit (am IMN, KIT): <em>Untersuchung des Zeitjitters von supraleitenden Einzelphotonen-Detektoren mit verschiedenen M&auml;anderformen</em>',
    ...
    'about.exp.hhi.li1':         'Entwicklung fortschrittlicher DSP f&uuml;r ratenadaptive THz-Funkkommunikation',
    'about.exp.hhi.li2':         'DSP auf Chip f&uuml;r hochgeschwindige koh&auml;rente 800G-ASICs',
    ...
    'about.exp.htw.intro':       'Vorbereitung und Durchf&uuml;hrung von Vorlesungen, &Uuml;bungen und Pr&uuml;fungen, Kerninhalte:',
    ...
    'about.exp.htw.li3':         'Einf&uuml;hrung in drahtlose und optische &Uuml;bertragungssysteme',
    ...
    'about.exp.bht.intro':       'Konzeption und Durchf&uuml;hrung fortgeschrittener Vorlesungen auf Masterniveau, Themen:',
    'about.exp.bht.li1':         'Fortgeschrittene Kommunikationstechnik und Systementwurf',
    'about.exp.bht.li2':         'Optische und drahtlose &Uuml;bertragungstechnologien',
    'about.exp.bht.li3':         'Kanalcodierung, adaptive Modulation und probabilistisches Shaping',
    'about.exp.thesis.title':    'Masterarbeit &mdash; Institut f&uuml;r Photonik und Quantenelektronik (IPQ), KIT',
    ...
    'about.skills.li2':   '<strong>Technologien:</strong> Hochgeschwindige THz-&Uuml;bertragungssysteme (WR-3-Band), PIN-Photodiodensender, WR3-Senderbaugruppen, koh&auml;rente optische ASICs (800G), Quadratur-Amplitudenmodulation (QAM)',
    'about.skills.li3':   '<strong>Werkzeuge:</strong> MATLAB (Simulation &amp; DSP), experimentelle optische/THz-Pr&uuml;fst&auml;nde, Oszilloskope und Spektrumanalysatoren, Signalgeneratoren',
