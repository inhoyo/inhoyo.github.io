...
const TRANSLATIONS = {
  ...
  en: {
    ...
    'research.1.text':  'Experimental 300&thinsp;GHz (WR-3) transmission systems built on photonic upconversion &mdash; from PIN-photodiode transmitters to receiver-side DSP. Demonstrated throughputs beyond 109&thinsp;Gbit/s, and a record <strong>221&thinsp;Gb/s dual-polarisation</strong> link over 500&thinsp;m.',
    'research.2.title': 'Adaptive Modulation &amp;<br />Converged 6G Links',
    'research.2.text':  'Rate-adaptive probabilistic shaping approaching the Shannon limit, integrated into converged fiber&ndash;THz backhaul architectures for 6G &mdash; the subject of my PhD dissertation at TU Berlin.',
    'research.3.title': 'Neuromorphic<br />Photonic Computing',
    'research.3.text':  'Optical signal processing on integrated photonic chips using neural networks &mdash; modulation format identification, signal correction, and feature extraction entirely in the optical domain at sub-nanosecond latency.',
    ...
    'hero.desc':            'Fraunhofer HHI, Berlin &mdash; building experimental THz systems beyond 100&thinsp;Gbit/s at 300&thinsp;GHz. Also Co-Founder &amp; CEO of <strong>LUXONNIC</strong>, reinventing the optical transceiver for AI infrastructure.',
    ...
    'sec.01.desc':          'From experimental 300&thinsp;GHz THz links to neuromorphic photonics &mdash; building the physical layer of 6G.',
  ...
  de: {
    ...
    'research.1.text':  'Experimentelle 300&thinsp;GHz-Funk\u00FCbertragungssysteme (WR-3) mit photonischer Aufw\u00E4rtskonvertierung &mdash; von PIN-Photodioden-Sendern bis zur empf&auml;ngerseitigen DSP. Durchs&auml;tze \u00FCber 109&thinsp;Gbit/s sowie ein Rekordwert von <strong>221&thinsp;Gb/s Dual-Polarisation</strong> \u00FCber 500&thinsp;m.',
    'research.2.title': 'Adaptive Modulation &amp;<br />Konvergierte 6G-Verbindungen',
    'research.2.text':  'Ratenadaptives probabilistisches Shaping nahe der Shannon-Grenze, integriert in konvergierte Glasfaser-THz-Backhaul-Architekturen f\u00FCr 6G &mdash; das Thema meiner Doktorarbeit an der TU Berlin.',
    'research.3.title': 'Neuromorphe<br />Photonische Datenverarbeitung',
    'research.3.text':  'Optische Signalverarbeitung auf integrierten photonischen Chips mit neuronalen Netzwerken &mdash; Modulationsformaterkennung, Signalkorrektur und Merkmalsgewinnung vollst\u00E4ndig im optischen Bereich mit Sub-Nanosekunden-Latenz.',
    ...
    'hero.desc':            'Fraunhofer HHI, Berlin &mdash; experimentelle THz-Systeme \u00FCber 100&thinsp;Gbit/s bei 300&thinsp;GHz. Zudem Mitgr\u00FCnder &amp; CEO von <strong>LUXONNIC</strong>, das den optischen Transceiver f\u00FCr KI-Infrastruktur neu erfindet.',
    ...
    'sec.01.desc':          'Von experimentellen 300&thinsp;GHz-THz-Strecken bis zur neuromorphen Photonik &mdash; ich baue die physikalische Schicht von 6G.',
    'sec.venture.label':    '03 &mdash; Venture',
  ...
  ko: {
    ...
    'research.1.text':  '광자 업변환 기반의 실험적 300&thinsp;GHz(WR-3) 무선 전송 시스템 &mdash; PIN 광검출기 송신기부터 수신단 DSP까지. 109&thinsp;Gbit/s를 넘는 전송률과 500&thinsp;m 거리에서 기록적인 <strong>221&thinsp;Gb/s 이중 편파</strong> 전송을 시연했습니다.',
    'research.2.title': '적응형 변조 &amp;<br />융합형 6G 링크',
    'research.2.text':  '섀넌 한계에 근접하는 전송률 적응형 확률적 성상 형성을 융합형 광섬유&ndash;THz 백홀 아키텍처에 적용합니다 &mdash; TU 베를린 박사 논문의 주제입니다.',
    'research.3.title': '뉴로모픽<br />포토닉 컴퓨팅',
    'research.3.text':  '신경망을 활용한 집적 포토닉 칩 기반 광학 신호 처리 &mdash; 변조 형식 식별, 신호 보정, 특징 추출을 나노초 이하의 지연 시간으로 완전히 광 영역에서 수행합니다.',
    ...
    'hero.desc':            '프라운호퍼 HHI, 베를린 &mdash; 300&thinsp;GHz에서 100&thinsp;Gbit/s를 넘는 실험적 THz 시스템을 구축합니다. 또한 AI 인프라용 광 트랜시버를 혁신하는 <strong>LUXONNIC</strong>의 공동창업자 &amp; CEO입니다.',
    'hero.btn.collab':      '협력 문의',
    'hero.btn.research':    '연구 보기',
    'hero.btn.luxonnic':    'LUXONNIC 방문하기',
    'affils.label':         '소속',
    ...
    'sec.01.title':         '연구 분야',
    'sec.01.desc':          '실험적 300&thinsp;GHz THz 링크부터 뉴로모픽 포토닉스까지 &mdash; 6G의 물리 계층을 구축합니다.',
