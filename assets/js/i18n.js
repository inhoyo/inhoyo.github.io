...
const TRANSLATIONS = {
  ...
  en: {
    ...
    'pub.award':     'Paper Award — OECC 2026',
    ...
    'hero.btn.luxonnic':    'Visit LUXONNIC',
    ...
    'news.tag.accelerator': 'Accelerator',
    'news.cdl.date':        'Sep 2026',
    'news.cdl.text':        '<strong>LUXONNIC</strong> admitted to the <strong>Creative Destruction Lab (CDL) Next Gen Computing Stream</strong> for the 2026/27 program year &mdash; jointly run by CDL-Paris and CDL-Berlin in partnership with <strong>HEC Paris</strong>, <strong>ESMT Berlin</strong>, and TU Munich&rsquo;s Campus Heilbronn.',
    'news.cdl.link':        'Learn More',
    'news.ahead.date':      'Sep 2026',
    'news.ahead.text':      '<strong>LUXONNIC</strong> accepted into <strong>Fraunhofer AHEAD</strong>, Fraunhofer&rsquo;s Deeptech Incubator and technology transfer bootcamp.',
    'news.ahead.link':      'Learn More',
    'news.6gconf.date':     'Sep 2026',
    'news.6gconf.text':     'Attending the <strong>Berlin 6G Conference</strong> next week &mdash; always happy to connect with fellow researchers and founders.',
    'news.6gconf.link':     'Conference Website',
    'news.pitchwin.date':   'Aug 2026',
    'news.pitchwin.text':   'Won the pitch competition at <strong>Deep Tech Night: Quantum &amp; Photonics</strong> in Berlin, pitching <strong>LUXONNIC</strong> to a room of investors, researchers, and founders.',
    'news.0.date':          'Aug 2026',
    'news.0.text':          'Spoke at <strong>Deep Tech Night: Quantum &amp; Photonics</strong> in Berlin, presenting <strong>LUXONNIC</strong> to investors, researchers, and founders alongside four other photonics and quantum startups.',
    'news.0.link':          'View Event',
    'news.5.date':          'Aug 2026',
    'news.5.text':          'Received the <strong>Lehrauftrag</strong> (teaching assignment) to return as <strong>Lecturer at HTW Berlin</strong> this winter semester, teaching <strong>Nachrichtenübertragung 2 (NUE2)</strong>.',
    'news.tag.record':      'World Record',
    'news.6.date':          '2026',
    'news.6.text':          'Set a new world record: <strong>221&thinsp;Gb/s dual-polarization THz wireless transmission</strong> over 500&thinsp;m in urban Berlin at 300&thinsp;GHz, achieving a rate&ndash;distance product exceeding 100&thinsp;Tb/s&middot;m &mdash; the highest reported to date.',
    'news.pub26oecc.date':  '2026',
    'news.pub26oecc.text':  'Paper published at the <strong>Opto-Electronics and Communications Conference (OECC)</strong>: &ldquo;Record 221&thinsp;Gb/s Dual Polarization THz Wireless Transmission Over 500&thinsp;m Using PCS-64QAM at 300&thinsp;GHz.&rdquo;',
    ...
    'news.2.date':          '2026',
    'news.2.text':          'Awarded the <strong>Paper Award at OECC 2026</strong> for a record 221&thinsp;Gb/s dual-polarization THz wireless transmission over 500&thinsp;m in urban Berlin, a rate&ndash;distance product exceeding 100&thinsp;Tb/s&middot;m in the 300&thinsp;GHz band.',
    ...
    'news.pub25a.date':     '2025',
    'news.pub25a.text':     'Paper published in the <strong>Journal of Lightwave Technology (JLT)</strong>: &ldquo;Experimental Characterization of Photodiode Transmitters for Probabilistically Shaped High-Speed THz Wireless Transmission.&rdquo;',
    'news.pub25b.date':     '2025',
    'news.pub25b.text':     'Co-authored paper published in the <strong>Journal of Lightwave Technology (JLT)</strong>: &ldquo;Analysis of Weather-Related Link Availabilities for Fiber-Integrated THz-Wireless Transmission Systems.&rdquo;',
    'news.pub25c.date':     '2025',
    'news.pub25c.text':     'Co-authored paper presented at the <strong>Optical Fiber Communication Conference (OFC)</strong>: &ldquo;High-Capacity THz Wireless Transmission Supporting Future 6G Optical Networks.&rdquo;',
    'news.pub24.date':      '2024',
    'news.pub24.text':      'Paper presented at the <strong>International Topical Meeting on Microwave Photonics</strong>: &ldquo;Experimental Characterization of a WR3-Coupled Photodiode Transmitter for High-Speed Terahertz Wireless Communication.&rdquo;',
    'news.pub23.date':      '2023',
    'news.pub23.text':      'Paper published in <strong>IET Conference Proceedings</strong>: &ldquo;32&thinsp;GBd, 109&thinsp;Gbit/s Probabilistically Shaped THz Wireless Transmission using PIN-PD Based Photonic Upconversion.&rdquo;',
    'news.7.date':          'Oct 2022',
    'news.7.text':          'Started as <strong>Lecturer at BHT Berlin</strong>, teaching in the M.Sc. Information and Communication programme.',
    'news.pub22a.date':     '2022',
    'news.pub22a.text':     'Paper presented at the <strong>23rd ITG-Symposium Photonic Networks</strong>: &ldquo;Time Adaptive Probabilistic Shaping for Combined Optical/THz Links.&rdquo;',
    'news.pub22b.date':     '2022',
    'news.pub22b.text':     'Co-authored paper presented at the <strong>23rd ITG-Symposium Photonic Networks</strong>: &ldquo;Experimental Investigation of Information Bit Scrambling for Physical-Layer Security in Coherent Fiber-Optic Systems.&rdquo;',
    'news.awardbw.date':    '2018',
    'news.awardbw.text':    'Awarded the <strong>Baden-Württemberg Scholarship</strong>.',
  ...
  de: {
    ...
    'hero.btn.luxonnic':    'LUXONNIC besuchen',
    ...
    'news.tag.event':       'Veranstaltung',
    'news.tag.accelerator': 'Accelerator',
    'news.cdl.date':        'Sep 2026',
    'news.cdl.text':        '<strong>LUXONNIC</strong> wurde in den <strong>Creative Destruction Lab (CDL) Next Gen Computing Stream</strong> für das Programmjahr 2026/27 aufgenommen &mdash; gemeinsam durchgeführt von CDL-Paris und CDL-Berlin in Partnerschaft mit <strong>HEC Paris</strong>, <strong>ESMT Berlin</strong> und dem Campus Heilbronn der TU München.',
    'news.cdl.link':        'Mehr erfahren',
    'news.ahead.date':      'Sep 2026',
    'news.ahead.text':      '<strong>LUXONNIC</strong> wurde in <strong>Fraunhofer AHEAD</strong> aufgenommen, den Deeptech-Inkubator und das Technologietransfer-Programm von Fraunhofer.',
    'news.ahead.link':      'Mehr erfahren',
    'news.6gconf.date':     'Sep 2026',
    'news.6gconf.text':     'Teilnahme an der <strong>Berlin 6G Conference</strong> n&auml;chste Woche &mdash; Austausch mit Forschenden und Gr&uuml;nder:innen jederzeit willkommen.',
    'news.6gconf.link':     'Zur Konferenz-Website',
    'news.pitchwin.date':   'Aug 2026',
    'news.pitchwin.text':   'Gewann den Pitch-Wettbewerb bei der <strong>Deep Tech Night: Quantum &amp; Photonics</strong> in Berlin mit dem Pitch von <strong>LUXONNIC</strong> vor Investor:innen, Forschenden und Gründer:innen.',
    'news.0.date':          'Aug 2026',
    'news.0.text':          'Vortrag bei der <strong>Deep Tech Night: Quantum &amp; Photonics</strong> in Berlin, wo <strong>LUXONNIC</strong> gemeinsam mit vier weiteren Photonik- und Quanten-Startups Investor:innen, Forschenden und Gründer:innen vorgestellt wurde.',
    'news.0.link':          'Veranstaltung ansehen',
    'news.5.date':          'Aug 2026',
    'news.5.text':          'Lehrauftrag für das kommende Wintersemester erhalten &mdash; Rückkehr als <strong>Lehrbeauftragter an der HTW Berlin</strong> mit der Vorlesung <strong>Nachrichtenübertragung 2 (NUE2)</strong>.',
    'news.tag.record':      'Weltrekord',
    'news.6.date':          '2026',
    'news.6.text':          'Neuer Weltrekord: <strong>221&thinsp;Gb/s Dual-Polarisations-THz-Funkübertragung</strong> über 500&thinsp;m im urbanen Berlin bei 300&thinsp;GHz, mit einem Raten-Distanz-Produkt von über 100&thinsp;Tb/s&middot;m &mdash; dem bislang höchsten berichteten Wert.',
    'news.pub26oecc.date':  '2026',
    'news.pub26oecc.text':  'Beitrag veröffentlicht bei der <strong>Opto-Electronics and Communications Conference (OECC)</strong>: &bdquo;Record 221&thinsp;Gb/s Dual Polarization THz Wireless Transmission Over 500&thinsp;m Using PCS-64QAM at 300&thinsp;GHz.&ldquo;',
    'news.1.date':          'Jul 2026',
    ...
    'news.2.date':          '2026',
    'news.2.text':          '<strong>Paper Award bei der OECC 2026</strong> f\u00FCr eine rekordverd\u00E4chtige 221&thinsp;Gb/s Dual-Polarisations-THz-Funk\u00FCbertragung \u00FCber 500&thinsp;m im urbanen Berlin, ein Raten-Distanz-Produkt von \u00FCber 100&thinsp;Tb/s&middot;m im 300&thinsp;GHz-Band.',
    ...
    'news.pub25a.date':     '2025',
    'news.pub25a.text':     'Beitrag ver\u00F6ffentlicht im <strong>Journal of Lightwave Technology (JLT)</strong>: &bdquo;Experimental Characterization of Photodiode Transmitters for Probabilistically Shaped High-Speed THz Wireless Transmission.&ldquo;',
    'news.pub25b.date':     '2025',
    'news.pub25b.text':     'Als Mitautor ver\u00F6ffentlicht im <strong>Journal of Lightwave Technology (JLT)</strong>: &bdquo;Analysis of Weather-Related Link Availabilities for Fiber-Integrated THz-Wireless Transmission Systems.&ldquo;',
    'news.pub25c.date':     '2025',
    'news.pub25c.text':     'Als Mitautor vorgestellt auf der <strong>Optical Fiber Communication Conference (OFC)</strong>: &bdquo;High-Capacity THz Wireless Transmission Supporting Future 6G Optical Networks.&ldquo;',
    'news.pub24.date':      '2024',
    'news.pub24.text':      'Beitrag vorgestellt beim <strong>International Topical Meeting on Microwave Photonics</strong>: &bdquo;Experimental Characterization of a WR3-Coupled Photodiode Transmitter for High-Speed Terahertz Wireless Communication.&ldquo;',
    'news.pub23.date':      '2023',
    'news.pub23.text':      'Beitrag ver\u00F6ffentlicht in den <strong>IET Conference Proceedings</strong>: &bdquo;32&thinsp;GBd, 109&thinsp;Gbit/s Probabilistically Shaped THz Wireless Transmission using PIN-PD Based Photonic Upconversion.&ldquo;',
    'news.7.date':          'Okt 2022',
    'news.7.text':          'Beginn als <strong>Lehrbeauftragter an der BHT Berlin</strong> im Masterstudiengang Information and Communication.',
    'news.pub22a.date':     '2022',
    'news.pub22a.text':     'Beitrag vorgestellt bei der <strong>23. ITG-Fachtagung Photonische Netze</strong>: &bdquo;Time Adaptive Probabilistic Shaping for Combined Optical/THz Links.&ldquo;',
    'news.pub22b.date':     '2022',
    'news.pub22b.text':     'Als Mitautor vorgestellt bei der <strong>23. ITG-Fachtagung Photonische Netze</strong>: &bdquo;Experimental Investigation of Information Bit Scrambling for Physical-Layer Security in Coherent Fiber-Optic Systems.&ldquo;',
    'news.awardbw.date':    '2018',
    'news.awardbw.text':    'Auszeichnung mit dem <strong>Baden-W\u00FCrttemberg-Stipendium</strong>.',
    'about.page.hero.eyebrow': 'Fraunhofer HHI &nbsp;·&nbsp; LUXONNIC &nbsp;·&nbsp; TU Berlin',
  ...
  ko: {
    ...
    'news.tag.talk':        '강연',
    'news.tag.event':       '행사',
    'news.tag.accelerator': '액셀러레이터',
    'news.cdl.date':        '2026년 9월',
    'news.cdl.text':        '<strong>LUXONNIC</strong>이 2026/27 프로그램 기수로 <strong>Creative Destruction Lab(CDL) Next Gen Computing Stream</strong>에 선발되었습니다 &mdash; CDL-파리와 CDL-베를린이 공동 운영하며, <strong>HEC 파리</strong>, <strong>ESMT 베를린</strong>, 뮌헨공과대학교(TUM) 하일브론 캠퍼스와 협력합니다.',
    'news.cdl.link':        '자세히 보기',
    'news.ahead.date':      '2026년 9월',
    'news.ahead.text':      '프라운호퍼의 딥테크 인큐베이터 겸 기술이전 프로그램인 <strong>Fraunhofer AHEAD</strong>에 <strong>LUXONNIC</strong>이 선발되었습니다.',
    'news.ahead.link':      '자세히 보기',
    'news.6gconf.date':     '2026년 9월',
    'news.6gconf.text':     '다음 주 <strong>Berlin 6G Conference</strong> 참석 &mdash; 연구자 및 창업자분들과의 교류를 언제나 환영합니다.',
    'news.6gconf.link':     '컨퍼런스 웹사이트',
    'news.pitchwin.date':   '2026년 8월',
    'news.pitchwin.text':   '베를린에서 열린 <strong>Deep Tech Night: Quantum &amp; Photonics</strong>에서 투자자, 연구자, 창업자들 앞에서 <strong>LUXONNIC</strong>을 발표해 피칭 대회에서 우승했습니다.',
    'news.0.date':          '2026년 8월',
    'news.0.text':          '베를린에서 열린 <strong>Deep Tech Night: Quantum &amp; Photonics</strong>에서 다른 포토닉스&middot;양자 스타트업 4곳과 함께 투자자, 연구자, 창업자들에게 <strong>LUXONNIC</strong>을 소개하는 강연.',
    'news.0.link':          '이벤트 보기',
    'news.5.date':          '2026년 8월',
    'news.5.text':          '이번 겨울학기 <strong>HTW 베를린</strong> 강의 위촉(Lehrauftrag)을 받아 <strong>겸임교수</strong>로 복귀, <strong>Nachrichtenübertragung 2 (NUE2)</strong> 강의 예정.',
    'news.tag.record':      '세계 기록',
    'news.6.date':          '2026년',
    'news.6.text':          '베를린 도심에서 500&thinsp;m 구간, 300&thinsp;GHz 대역에서 <strong>221&thinsp;Gb/s 이중 편파 THz 무선 전송</strong>으로 100&thinsp;Tb/s&middot;m를 초과하는 전송률&middot;거리 곱을 달성해 새로운 세계 기록을 수립했습니다.',
    'news.pub26oecc.date':  '2026년',
    'news.pub26oecc.text':  '<strong>Opto-Electronics and Communications Conference (OECC)</strong>에 &ldquo;Record 221&thinsp;Gb/s Dual Polarization THz Wireless Transmission Over 500&thinsp;m Using PCS-64QAM at 300&thinsp;GHz&rdquo; 논문 게재.',
    ...
    'news.2.date':          '2026년',
    'news.2.text':          '베를린 도심에서 500&thinsp;m 구간, 300&thinsp;GHz 대역에서 100&thinsp;Tb/s&middot;m를 초과하는 전송률&middot;거리 곱을 달성한 기록적인 221&thinsp;Gb/s 이중 편파 THz 무선 전송으로 <strong>OECC 2026 논문상</strong> 수상.',
    ...
    'news.pub25a.date':     '2025년',
    'news.pub25a.text':     '<strong>Journal of Lightwave Technology (JLT)</strong>에 &ldquo;Experimental Characterization of Photodiode Transmitters for Probabilistically Shaped High-Speed THz Wireless Transmission&rdquo; 논문 게재.',
    'news.pub25b.date':     '2025년',
    'news.pub25b.text':     '<strong>Journal of Lightwave Technology (JLT)</strong>에 공동저자로 &ldquo;Analysis of Weather-Related Link Availabilities for Fiber-Integrated THz-Wireless Transmission Systems&rdquo; 논문 게재.',
    'news.pub25c.date':     '2025년',
    'news.pub25c.text':     '<strong>Optical Fiber Communication Conference (OFC)</strong>에서 공동저자로 &ldquo;High-Capacity THz Wireless Transmission Supporting Future 6G Optical Networks&rdquo; 발표.',
    'news.pub24.date':      '2024년',
    'news.pub24.text':      '<strong>International Topical Meeting on Microwave Photonics</strong>에서 &ldquo;Experimental Characterization of a WR3-Coupled Photodiode Transmitter for High-Speed Terahertz Wireless Communication&rdquo; 발표.',
    'news.pub23.date':      '2023년',
    'news.pub23.text':      '<strong>IET Conference Proceedings</strong>에 &ldquo;32&thinsp;GBd, 109&thinsp;Gbit/s Probabilistically Shaped THz Wireless Transmission using PIN-PD Based Photonic Upconversion&rdquo; 논문 게재.',
    'news.7.date':          '2022년 10월',
    'news.7.text':          '<strong>BHT 베를린 겸임교수</strong>로 임용되어 Information and Communication 석사 과정을 강의 시작.',
    'news.pub22a.date':     '2022년',
    'news.pub22a.text':     '<strong>제23회 ITG 심포지엄 Photonic Networks</strong>에서 &ldquo;Time Adaptive Probabilistic Shaping for Combined Optical/THz Links&rdquo; 발표.',
    'news.pub22b.date':     '2022년',
    'news.pub22b.text':     '<strong>제23회 ITG 심포지엄 Photonic Networks</strong>에서 공동저자로 &ldquo;Experimental Investigation of Information Bit Scrambling for Physical-Layer Security in Coherent Fiber-Optic Systems&rdquo; 발표.',
    'news.awardbw.date':    '2018년',
    'news.awardbw.text':    '<strong>바덴뷔르템베르크 장학금</strong> 수혜.',
